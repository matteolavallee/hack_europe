...
async def get_care_receivers_list():
...
async def get_care_receiver(receiver_id: str):
    receivers_data = json_store_service.get_care_receivers()
...
async def create_care_receiver(payload: CareReceiverCreate):
    receivers_data = json_store_service.get_care_receivers()
...
async def update_care_receiver(receiver_id: str, payload: CareReceiverUpdate):
    receivers_data = json_store_service.get_care_receivers()
